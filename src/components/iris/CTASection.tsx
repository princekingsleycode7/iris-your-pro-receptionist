...
export function CTASection() {
  return (
    <section id="cta" className="py-24 md:py-32 px-6 md:px-10 bg-white border-t border-black/5">
      <Reveal>
        <div className="max-w-5xl mx-auto relative bg-tesla-dark text-white rounded-[2rem] md:rounded-[2.5rem] p-8 sm:p-12 md:p-16 overflow-hidden">
